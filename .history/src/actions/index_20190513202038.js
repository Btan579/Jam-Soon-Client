            ...
            for (let i = 0; i < events.length; i++) {
                ...
                performers.forEach(function (performer, index) {
                   ...
                   let act = {
                    ...
                    performanceArray.push(act);
                });
                let perfArray = [];
                for (let j = 0; j < performers.length; j++) {
                    let ham = {
                        artist_id: performers[j].artist.id,
                        artistName: performers[j].artist.displayName,
                        billSlot: performers[j].billing,
                        billIndex: performers[j].billingIndex
                    };
                    return perfArray.push(ham);
                }
                ...
                dispatch(fetchEventsSuccess(eventDay, eventName, headliner, headlinerPlaylist, secondArtist, secondArtistPlaylist, venueName, venueLocation, event_id, perfArray));
            }
        });
};
