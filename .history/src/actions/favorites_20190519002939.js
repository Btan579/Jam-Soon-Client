...
export const addFavoriteEvent = (userID, favEventName, favDate, favHeadliner, favSupportingArtists, favVenue, favVenueLocation, event_id) => (dispatch, getState) => {
    console.log(favEventName, userID, favDate, favHeadliner, favSupportingArtists, favVenue, favVenueLocation, event_id);
    ...
    return fetch(`${API_BASE_URL}/favevents/`, {
        ...
        body: JSON.stringify({
            favEventName, favDate, favHeadliner, favSupportingArtists, favVenue, favVenueLocation, event_id, userID
        })
    })
...
export const addFavoriteArtist = (favArtistName, playlistUrl, artist_id, user_id) => (dispatch, getState) => {
    ...
    return fetch(`${API_BASE_URL}/favartists/`, {
        ...
        .then((data) => {
            ...
            let playlistUrl = artist.playlistUrl;
            let artist_id = artist.artist_id;
            let user_id = artist.user_id;
            dispatch(addFavoriteArtistSuccess(_id, favArtistName, playlistUrl, artist_id, user_id));
        })
        .catch(err => {
