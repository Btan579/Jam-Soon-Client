...
export const fetchFavoriteArtistsSuccess = (_id, name, video, artist_id, user_id ) => ({
...
export const addFavoriteArtistSuccess = (favArtistName, videoUrl, artist_id, user_id, _id) => ({
...
export const addFavoriteArtist = (favArtistName, videoUrl, artist_id, user_id) => (dispatch, getState) => {
    const authToken = getState().auth.authToken;
    return fetch(`${API_BASE_URL}/favartists/`, {
        ...
        .then((data) => {
            ...
            dispatch(addFavoriteArtistSuccess(_id, favArtistName, videoUrl, artist_id, user_id));
        })
        .catch(err => {
    ...
    return fetch(`${API_BASE_URL}/favartists/${user_id}`, {
        ...
        .then((data) => {
            ...
            artists.forEach(function (artist)   {
                ...
                let video = artist.videoUrl;
                let artist_id = artist.artist_id;
                let user_id = artist.user_id;
                dispatch(fetchFavoriteArtistsSuccess(_id, name, video, artist_id, user_id));
            });
        })
        .catch(err => {
            dispatch(fetchFavoriteArtistsError(err));
