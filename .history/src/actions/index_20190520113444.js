...
export const fetchEventsSuccess = (eventDay, eventName, headlinerPlaylist, secondArtist, secondArtistPlaylist, venueName, venueLocation, event_id, performingArtists) => ({
