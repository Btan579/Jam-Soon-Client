    ...
    constructor(props) {
       ...
       saveEvent(event) {
          ...
          supportArtists.shift();
           let userID = this.props.currentUser_id;
           const user_id = u_id;
          ...
          const event_id = this.props.event_id;
           ...
           this.props.dispatch(addFavoriteEvent(favEventName, favDate, favHeadliner, favSupportingArtists, favVenue, favVenueLocation, userID, event_id));
       }
