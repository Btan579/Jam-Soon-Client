...
export class EventsSection extends React.Component {
    ...
    render() {
        ...
        // let ppp = this.props.videosData.filter(pperformer => {
        //     console.log(pperformer);
        //     return pperformer.event_id === eventId;
        ...
        //     />
        // ));
        const pperfs = this.props.videosData;
...
const mapStateToProps = state => ({
    ...
    videos: state.eventsState.videosData
});
