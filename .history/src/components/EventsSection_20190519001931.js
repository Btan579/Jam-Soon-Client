    ...
    constructor(props) {
       ...
       saveEvent(event) {
          ...
          const favVenueLocation = this.props.venueLocation;
           let u_id = this.props.currentUser_id;
          const user_id = u_id;
          const event_id = this.props.event_id;
           console.log(user_id);
        
           this.props.dispatch(addFavoriteEvent(favEventName, favDate, favHeadliner, favSupportingArtists, favVenue, favVenueLocation, user_id, event_id));
       }
