...
export class EventsSection extends React.Component {
    ...
    render() {
        ...
        const performers = this.props.playlistsData.map((performer, index) => (
            <PerformerSection
                key={index}
                ...
                playlist_id={performer.playlist_id}
        ...
        let selectedPerf = performers.map(function (performer) { 
            return performer.eventId });
...
const mapStateToProps = state => ({
    ...
    playlistsData: state.eventsState.playlistsData
});
