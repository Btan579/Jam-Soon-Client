...
describe('<FavoriteArtists />', () => {
    ...
    it('Dispatches deleteFavoriteArtist from deleteFavoriteArtist', () => {
        ...
        const _id = seedFavArtists[0]._id;
        // console.log(wrapper.debug(dispatch));
        instance.mockdeleteFavoriteArtistdAction(_id);
        expect(dispatch).toHaveBeenCalledWith(mockdeleteFavoriteArtistdAction(_id));
    });
