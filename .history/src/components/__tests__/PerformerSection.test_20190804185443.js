...
describe('<PerformerSection />', () => {
    ...
    it('Dispatches addFavoriteArtist from saveArtist', () => {
        ...
        const wrapper = shallow(
            <PerformerSection user_id={user_id} event_id={event_id} artist_id={artist_id} favArtistName={favArtistName} videoUrl={videoUrl} dispatch={dispatch} />
        );

        const instance = wrapper.instance();

        instance.saveArtist(favArtistName, videoUrl,  user_id, event_id);
