...
export class EventsSection extends React.Component {
    ...
    render() {
        // let event = this.props.events.find(function(event_id) {
        //     return event_id;
        // });

        // // const perf = event.performingArtists.map((art, index) => (
        // //     <div key={index}>
        // //         <p>{art.artistName}</p>
        // //         <p>{art.artist_id}</p>
        // //         <p>{art.billIndex}</p>
        ...
        // // ));
        // const  perfs = event.performingArtists.map((performer, index) => (
        ...
        // console.log(event.performingArtists);
        return (
            ...
            >
                <h4>{this.props.eventName}</h4>
                    ...
                    {/* <p>{event.performingArtists.artistName}</p> */}
                        {this.props.performingArtists.map((performer, index) => (
                                <div key={index} className="performer">
                                {/* {console.log(performer.artist_id)} */}
                                    <h5>{performer.artistName}</h5>
                                    <p>{performer.artist_id}</p>
                                    <p>{performer.billIndex}</p>
                                    <p>{performer.billSlot}</p>
